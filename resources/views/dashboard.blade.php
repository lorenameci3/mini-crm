...
<div class="content">
    ...
    <div class="col-xl-8">
        ...
        <div class="table-responsive">
            ...
            <tbody>
                <tr>
                <td>iPone X</td>
                <td><img src="{{asset('img/s.jpg')}}" class="img-circle img-w-30" alt="User Image"></td>
    ...
    <div class="col-lg-4 m-b-3">
        ...
        <div class="widget-user-header bg-yellow">
            <div class="widget-user-image"> <img class="img-circle" src="{{asset('img/s.jpg')}}" alt="User Avatar"> </div>
        ...
        <div class="card-body">
            ...
            <div class="box-body"> 
                ...
                <div class="direct-chat-msg">
                    ...
                    <img class="direct-chat-img" src="{{asset('img/s.jpg')}}" alt="user image">
