                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group has-feedback">
                                        ...
                                        <input class="form-control" placeholder="Phone" type="text" name="phone" value="{{ $account_details->phone }}">
                                        <span class="fa fa-user form-control-feedback" aria-hidden="true"></span> 
                                    </div>
                                    @error('phone')
                                        <small class="text-danger">{{$message}}</small>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group has-feedback">
                                        ...
                                        <input class="form-control" placeholder="Website" type="text" name="website" value="{{ $account_details->website }}">
